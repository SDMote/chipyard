...
class MyAbstractConfig extends Config(
  // ================================================
  //   Set up TestHarness
  // ================================================
  // The HarnessBinders control generation of hardware in the TestHarness
  ...
  // Coherency settings
  new freechips.rocketchip.subsystem.WithInclusiveCache(capacityKB = 4, nWays = 2, subBankingFactor = 2, writeBytes = 4) ++          /** use Sifive LLC cache as root of coherence */
