...
class DigitalTop(implicit p: Parameters) extends ChipyardSystem
  ...
  with chipyard.example.CanHaveMyPeriph // Enable custom peripheral
  with chipyard.example.CanHaveSecPeriph // Enable custom peripheral
  with testchipip.soc.CanHaveOnChipMainMemory // Enable main memory
